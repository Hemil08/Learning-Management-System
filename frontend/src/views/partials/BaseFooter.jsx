...
function BaseFooter() {
    return (
        <footer className="pt-lg-8 pt-5 footer bg-dark text-white" style={{ marginTop: "90px" }}>
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6 col-12 text-white">
                        ...
                        <div className="mb-4">
                            <h1>MyCode LMS</h1>
                            <div className="mt-4">
                                <p>MyCode is feature-rich components and beautifully Bootstrap UIKit for developers, built with bootstrap responsive framework.</p>
                                {/* social media */}
