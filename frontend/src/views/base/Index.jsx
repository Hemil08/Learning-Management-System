                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 d-flex justify-content-center">
                            ...
                            <div className="position-relative">
                                <img src="https://geeksui.codescandy.com/geeks/assets/images/background/acedamy-img/girl-image.png" alt="girl" className="end-0 bottom-0" />
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div className="item">
                                                <div className="card">
                                                    <div className="card-body text-center p-6">
                                                        {/* img */}
                                                        <img src={avatar} alt="avatar" className="avatar avatar-lg rounded-circle w-50" />
